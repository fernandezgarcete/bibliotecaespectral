...
class Cobertura(db.Model):
    ...
    altura = db.Column(db.Float(precision=3))
...
class Radiometro(db.Model):
    ...
    tiempo_escaneo = db.Column(db.Float(precision=3))
    reproducibilidad_ancho_banda = db.Column(db.Float(precision=2))
    exactitud_ancho_banda = db.Column(db.Float(precision=2))
    ...
    largo_fibra_optica = db.Column(db.Float(precision=2))
    fov = db.Column(db.Float(precision=3))
...
class Metodologia(db.Model):
    ...
    angulo_cenital = db.Column(db.Float(precision=3))
    angulo_azimutal = db.Column(db.Float(precision=3))
...
class Punto(db.Model):
    ...
    geom = db.Column(Geometry(geometry_type='POINT', srid=4326))
    altura_medicion = db.Column(db.Float(precision=4))
    presion = db.Column(db.Float(precision=4))
    temperatura = db.Column(db.Float(precision=2))
    nubosidad = db.Column(db.Integer)
    viento_direccion = db.Column(db.String(40))
    viento_velocidad = db.Column(db.Float(precision=3))
...
class Fotometria(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    sig380 = db.Column(db.Float(precision=7))
    sig500 = db.Column(db.Float(precision=7))
    sig675 = db.Column(db.Float(precision=7))
    sig870 = db.Column(db.Float(precision=7))
    sig1020 = db.Column(db.Float(precision=7))
    std380 = db.Column(db.Float(precision=7))
    std500 = db.Column(db.Float(precision=7))
    std675 = db.Column(db.Float(precision=7))
    std870 = db.Column(db.Float(precision=7))
    std1020 = db.Column(db.Float(precision=7))
    r380 = db.Column(db.Float(precision=7))
    r500 = db.Column(db.Float(precision=7))
    r675 = db.Column(db.Float(precision=7))
    r870 = db.Column(db.Float(precision=7))
    r1020 = db.Column(db.Float(precision=7))
...
class ProductoRadiancia(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    reflectancia = db.Column(db.Float(precision=20))
    radiancia_avg = db.Column(db.Float(precision=20))
    radiancia_std = db.Column(db.Float(precision=20))
    id_punto = db.Column(db.Integer, db.ForeignKey('punto.id'))
...
class Radiometria(db.Model):
    ...
    radiancia = db.Column(db.Float(precision=20))
    id_punto = db.Column(db.Integer, db.ForeignKey('punto.id'))

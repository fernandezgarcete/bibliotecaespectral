...
class Cobertura(db.Model):
    ...
    altura = db.Column(db.DECIMAL(precision=3))
...
class Radiometro(db.Model):
    ...
    tiempo_escaneo = db.Column(db.DECIMAL(precision=3))
...
class Metodologia(db.Model):
    ...
    angulo_cenital = db.Column(db.DECIMAL(precision=3))
    angulo_azimutal = db.Column(db.DECIMAL(precision=3))
...
class Punto(db.Model):
    ...
    geom = db.Column(Geometry(geometry_type='POINT', srid=4326))
    altura_medicion = db.Column(db.DECIMAL(precision=4))
    presion = db.Column(db.DECIMAL(precision=4))
    temperatura = db.Column(db.DECIMAL(precision=2))
    nubosidad = db.Column(db.Integer)
    viento_direccion = db.Column(db.String(40))
    viento_velocidad = db.Column(db.DECIMAL(precision=3))
